...
\restrict UFBlunqKRIw78PifFC61Lp0I1LKHAdD8BAEviON5sOmgvt5pnk0YM96z3Yw5pdh
...
10	18	8	1	\N	PIVG260410XXXXXX	2026-04-10
11	19	8	1	\N	PIVG260410XXXXXY	2026-04-10
\.


--
-- Data for Name: catalogo_categorias; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.catalogo_categorias (id_categoria, nombre_categoria) FROM stdin;
1	Infantil
2	Juvenil
3	Libre
4	Veteranos
...
--
-- Data for Name: catalogo_estadocivil; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.catalogo_estadocivil (id_estadocivil, nombre_estado) FROM stdin;
1	Soltero(a)
2	Casado(a)
3	Divorciado(a)
4	Viudo(a)
...
COPY public.catalogo_genero (id_genero, nombre_genero) FROM stdin;
1	Masculino
2	Femenino
3	No Binario
...
--
-- Data for Name: catalogo_nivelestudios; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.catalogo_nivelestudios (id_nivel, nombre_nivel) FROM stdin;
1	Primaria
2	Secundaria
...
--
-- Data for Name: catalogo_sexo; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.catalogo_sexo (id_sexo, nombre_sexo) FROM stdin;
1	Hombre
2	Mujer
3	Intersexual
\.
...
--
-- Data for Name: catalogo_tiposangre; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.catalogo_tiposangre (id_tiposangre, grupo_sanguineo) FROM stdin;
1	A+
2	A-
3	B+
4	B-
...
--
-- Data for Name: detalles_atletas; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.detalles_atletas (id_detalle, id_atleta, id_categoria, id_talla_camisa, id_talla_pantalon, id_talla_short, id_talla_chamarra, talla_calzado, id_nivel_estudios, institucion_escolar) FROM stdin;
2	10	1	2	3	2	2	27.5	4	Universidad Libre
3	11	1	2	3	2	2	27.5	4	Universidad Libre
\.
...
COPY public.domicilios (id_domicilio, id_usuario, celular, telefono_fijo, codigo_postal, colonia, direccion_calle, cruzamientos, num_exterior, num_interior, manzana, lote) FROM stdin;
2	18	9831234567	\N	77930	Centro	Calle 22	Entre 5 y 7	12	\N	4	2
3	19	9831234567	\N	77930	Centro	Calle 22	Entre 5 y 7	12	\N	4	2
\.
...
12	16	Lic. Educación Física	\N	\N	Atletismo	GAAA060101XXXXXXXA
\.
...
--
-- Data for Name: perfiles_medicos; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.perfiles_medicos (id_perfil_medico, id_atleta, id_tiposangre, peso_kg, estatura_mts, alergias_condiciones) FROM stdin;
2	10	1	65.50	1.70	Ninguna
3	11	1	65.50	1.70	Ninguna
\.


--
-- Data for Name: perfiles_personales; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.perfiles_personales (id_perfil, id_usuario, id_sexo, id_genero, id_estadocivil, rfc, nss, clave_ine, lugar_nacimiento) FROM stdin;
2	18	2	2	1	PIVG260410A1	12345678901	ABCDEF12345678	Bacalar, Quintana Roo
3	19	2	2	1	PIVG260410A2	12345678902	ABCDEF12345679	Bacalar, Quintana Roo
\.
...
COPY public.usuarios (id_usuario, id_rol, nombre, primer_apellido, correo, password, estado_cuenta, segundo_apellido) FROM stdin;
1	1	Usuario	De Prueba	prueba@test.com	password123	t	\N
10	2	Gerardo	Amaro	jerrygab2006@gmail.com	$2b$10$zqtAwW38Gg4NbVWp2ro4kuA0V3v9liPSlniF7gvwqesWjInzGMVYe	t	\N
16	2	Gerardo	Amaro	prueba@gmail.com	$2b$10$idjkxODQAWsPAFi4kC2rq..UN7OFRiWSa52vAI.CMJwSHr2dEjd/a	t	Perez
18	1	Victoria	Piña	vic@gmail.com	$2b$10$mxgXWAc0b8xMD.N6zD5sBOu.7oZ4tgrKsfPcTXyJ3Pp5Hzkekh6EO	t	\N
19	1	Victoria	Piña	vic2@gmail.com	$2b$10$NRoMVNU.7fEChGhqoYXyt.F9Yk/24kfjFvThQejv1bLkpVh802W0a	t	\N
\.
...
SELECT pg_catalog.setval('public.atletas_id_atleta_seq', 12, true);


--
-- Name: catalogo_categorias_id_categoria_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.catalogo_categorias_id_categoria_seq', 4, true);


--
-- Name: catalogo_estadocivil_id_estadocivil_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.catalogo_estadocivil_id_estadocivil_seq', 5, true);
...
--
-- Name: catalogo_genero_id_genero_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.catalogo_genero_id_genero_seq', 4, true);


--
-- Name: catalogo_nivelestudios_id_nivel_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.catalogo_nivelestudios_id_nivel_seq', 5, true);
...
--
-- Name: catalogo_sexo_id_sexo_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.catalogo_sexo_id_sexo_seq', 3, true);
...
SELECT pg_catalog.setval('public.catalogo_tallas_id_talla_seq', 8, true);
...
--
-- Name: catalogo_tiposangre_id_tiposangre_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.catalogo_tiposangre_id_tiposangre_seq', 8, true);
...
--
-- Name: detalles_atletas_id_detalle_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.detalles_atletas_id_detalle_seq', 4, true);
...
SELECT pg_catalog.setval('public.disciplinas_id_disciplina_seq', 5, true);
...
--
-- Name: domicilios_id_domicilio_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.domicilios_id_domicilio_seq', 3, true);
...
SELECT pg_catalog.setval('public.entrenadores_id_entrenador_seq', 12, true);
...
--
-- Name: perfiles_medicos_id_perfil_medico_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.perfiles_medicos_id_perfil_medico_seq', 3, true);


--
-- Name: perfiles_personales_id_perfil_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.perfiles_personales_id_perfil_seq', 3, true);
...
--
-- Name: detalles_atletas detalles_atletas_id_atleta_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.detalles_atletas
    ADD CONSTRAINT detalles_atletas_id_atleta_key UNIQUE (id_atleta);
...
--
-- Name: perfiles_medicos perfiles_medicos_id_atleta_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.perfiles_medicos
    ADD CONSTRAINT perfiles_medicos_id_atleta_key UNIQUE (id_atleta);
...
--
-- Name: detalles_atletas detalles_atletas_id_atleta_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.detalles_atletas
    ADD CONSTRAINT detalles_atletas_id_atleta_fkey FOREIGN KEY (id_atleta) REFERENCES public.atletas(id_atleta) ON DELETE CASCADE;
...
--
-- Name: perfiles_medicos perfiles_medicos_id_atleta_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.perfiles_medicos
    ADD CONSTRAINT perfiles_medicos_id_atleta_fkey FOREIGN KEY (id_atleta) REFERENCES public.atletas(id_atleta) ON DELETE CASCADE;
...
\unrestrict UFBlunqKRIw78PifFC61Lp0I1LKHAdD8BAEviON5sOmgvt5pnk0YM96z3Yw5pdh
